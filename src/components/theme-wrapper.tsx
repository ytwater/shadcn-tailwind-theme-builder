...
export function ThemeWrapper({ defaultTheme, children, className }: ThemeWrapperProps) {
  ...
  return (
    <div
      ...
      style={
        {
          "--background": isLight ? config.light.background : config.dark.background,
          "--foreground": isLight ? config.light.foreground : config.dark.foreground,
          ...
          "--secondary": isLight ? config.light.secondary : config.dark.secondary,
          ...
          "--destructive": isLight ? config.light.destructive : config.dark.destructive,
